...
function PromptInput({
  ...
  return (
    <TooltipProvider>
      ...
      >
        <div
          className={cn("cursor-text rounded-md p-2 py-1 shadow-around", className)}
...
function PromptInputTextarea({ className, onKeyDown, disableAutosize = false, ...props }: PromptInputTextareaProps) {
  ...
  return (
    <Textarea
      ...
      autoCapitalize="off"
      className={cn(
        "min-h-[48px] w-full resize-none border-none bg-transparent text-primary shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0",
        className,
      )}
      rows={1}
      disabled={disabled}
