...
- 字节豆包（2026-08-30 收录核实）：[火山方舟模型列表](https://www.volcengine.com/docs/82379/1554680)（ID 连字符式+六位日期快照如 doubao-seed-2-1-pro-260628）、[深度思考（Responses API thinking 字段）](https://docs.volcengine.com/docs/82379/1956279)（thinking.type 三态 enabled/disabled/auto）、[模型价格](https://docs.volcengine.com/docs/82379/1544106)、[模型发布公告](https://www.volcengine.com/docs/82379/1159178)、[Seed1.6 技术博客](https://seed.bytedance.com/zh/blog/introduction-to-techniques-used-in-seed1-6)、[Seed2.1 发布博客](https://seed.bytedance.com/zh/blog/seed2-1-officially-released-advancing-ai-productivity)；视觉口径交叉源：[doubao-pro-32k 单页（输入仅 Text 实证）](https://www.volcengine.com/docs/82379/1554680)、[Doubao-Seed-1.6-flash 百科（多模态+TPOT 10ms）](https://baike.baidu.com/item/Doubao-Seed-1.6-flash/65763655)、[360 智脑 doubao-seed-2-0-mini 转售页](https://ai.360.com/open/zh/models/bytedance/doubao-seed-2-0-mini)。未核实挂账：doubao-seed-evolving 视觉口径、2-0-mini 四档推理强度的 API 参数面
