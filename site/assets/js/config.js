...
window.SITE_CONFIG = {
   ...
   * 详细步骤见 DEPLOY.md 第 2 步。当前走 CDN 加速域名（回源 COS，IP 限频 +
   * 带宽封顶已生效，见 DEPLOY.md 第 6 节） */
  cosBase: "https://dl.bettersageread.cn",
      ...
      assets: [
        {
          ...
          size: "135.6 MB",
          count: 4,
          url: "https://github.com/Feplus2/better-sageread/releases/download/v0.3.1/Better.SageRead_0.2.1_x64-setup.exe",
        },
        {
          id: "msi",
          pick: "x64_en-US.msi",
          ...
          size: "138.5 MB",
          count: 0,
          url: "https://github.com/Feplus2/better-sageread/releases/download/v0.3.1/Better.SageRead_0.2.1_x64_en-US.msi",
        },
      ],
    },
