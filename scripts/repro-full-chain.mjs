...
const { cutPaperBlocks, renderTranslationHtml } = await import("./pb-bundle.mjs");
const { normalizeLiveElement, normalizeMathText, mapTgtRangeToSrc, mapSourceOffsetsToLive, tokenizeWords } = await import("./pca-bundle.mjs");
